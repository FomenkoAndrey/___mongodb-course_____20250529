...
async function run() {
  ...
  try {
    ...
    const ascendingSortedDocuments = await db
      ...
      .toArray()
    console.log(chalk.magentaBright('Documents sorted by age in ascending order:'), ascendingSortedDocuments)
    ...
    const descendingSortedDocuments = await db
      ...
      .toArray()
    console.log(chalk.magentaBright('Documents sorted by age in descending order:'), descendingSortedDocuments)
